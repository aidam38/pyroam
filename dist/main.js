...
exports.getActiveBlockUid = exports.createUid = exports.addScriptToPage = exports.addElementToPage = exports.sleep = void 0;
...
exports.writeToNextBlock = exports.createBlock = exports.updateBlock = exports.q = void 0;
...
var writeToNextBlock = function writeToNextBlock(uid, string) {
  return __awaiter(void 0, void 0, void 0, function () {
    var query, result, block, parent, siblings, newUid, nextSibling;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
        ...
        case 1:
          ...
          block = result[0][0];
          parent = block._children[0];
          siblings = parent.children;

          if (!siblings.some(function (sibling) {
            return sibling.order > block.order;
          })) {
            newUid = helpers_1.createUid();
            exports.createBlock(parent.uid, block.order + 1, newUid, string);
          } else {
            nextSibling = siblings.filter(function (sibling) {
              return sibling.order === block.order + 1;
            })[0];
            exports.updateBlock(nextSibling.uid, string);
          }
...
exports.writeToNextBlock = writeToNextBlock;
},{"./helpers":"helpers.ts"}],"keyboard.ts":[function(require,module,exports) {
"use strict";
...
var runActiveBlockAndWriteToNext = function runActiveBlockAndWriteToNext() {
  return __awaiter(void 0, void 0, void 0, function () {
    var uid, query, result, content, ttt, code, out;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
        ...
        case 1:
          result = _a.sent();
          content = result[0][0].string;
          ttt = "``" + "`";
          code = content.replace(ttt + "python", "").replace(ttt, "");
          return [4
          /*yield*/
        ...
        case 2:
          ...
          return [4
          /*yield*/
          , api_1.writeToNextBlock(uid, out || "")];
...
},{"./helpers":"helpers.ts","./api":"api.ts","./pyodide":"pyodide.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
