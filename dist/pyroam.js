...
exports.processCodeBlocks = exports.getActiveCodeBlockContent = exports.removeBackticks = exports.getActiveBlockUid = exports.createUid = exports.addScriptToPage = exports.addElementToPage = exports.sleep = void 0;
/* ====== BASIC ======= */
...
var addScriptToPage = function addScriptToPage(tagId, script) {
  (0, exports.addElementToPage)(Object.assign(document.createElement("script"), {
    src: script
...
var processCodeBlocks = function processCodeBlocks(codeblocks, uid) {
  ...
  cells = cells.filter(function (cell) {
    ...
    return {
      uid: cell.uid,
      string: (0, exports.removeBackticks)(cell.string)
    };
  });
  return cells;
};
...
var loadPyodide = function loadPyodide() {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          (0, helpers_1.addScriptToPage)("pyodide", "https://cdn.jsdelivr.net/pyodide/v0.16.1/full/pyodide.js");
          return [4
          /*yield*/
          , (0, helpers_1.sleep)(2000)];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          if (!result) {
            nestedUid = (0, helpers_1.createUid)();
            (0, exports.createBlock)(parentUid, 0, nestedUid, string);
          } else {
            nestedUid = result[0][0].uid;
            (0, exports.updateBlock)(nestedUid, string);
          }
...
var getAllCodeBlocksNestedUnder = function getAllCodeBlocksNestedUnder(topUid) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    :where  [?notebookBlock :block/uid "' + topUid + '"]\
        ...
        case 1:
          results = _a.sent();
          cells = (0, helpers_1.processCodeBlocks)(results, topUid);
          return [2
          /*return*/
          , cells];
      }
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , (0, api_1.getAllCodeBlocksNestedUnder)(notebookUid)];

        case 1:
          cells = _a.sent();
          activeUid = (0, helpers_1.getActiveBlockUid)();
          _i = 0, cells_1 = cells;
          _a.label = 2;
        ...
        case 2:
          ...
          , 6];
          cell = cells_1[_i];
          if (cell.uid === activeUid) cell.string = (0, helpers_1.getActiveCodeBlockContent)();
          return [4
          /*yield*/
          , (0, pyodide_1.runPython)(cell.string)];

        case 3:
          out = _a.sent();
          return [4
          /*yield*/
          , (0, api_1.writeToNestedBlock)(cell.uid, out)];
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          activeUid = (0, helpers_1.getActiveBlockUid)();
          code = (0, helpers_1.getActiveCodeBlockContent)();
          return [4
          /*yield*/
          , (0, pyodide_1.runPython)(code)];

        case 1:
          out = _a.sent();
          return [4
          /*yield*/
          , (0, api_1.writeToNestedBlock)(activeUid, out)];
...
var runActiveNotebook = function runActiveNotebook() {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          uid = (0, helpers_1.getActiveBlockUid)();
          return [4
          /*yield*/
          , (0, api_1.getUidOfClosestBlockReferencing)(uid, "pyroam/notebook")];
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      if (e.code === "Enter" && e.altKey === true && !e.shiftKey) {
        (0, notebook_1.runActiveBlockAndWriteToNext)();
      } else if (e.code === "Enter" && e.altKey === true && e.shiftKey === true) {
        (0, notebook_1.runActiveNotebook)();
      }
